...
configurationMetadata = cms.untracked.PSet(
        ...
        annotation = cms.untracked.string('Spring 2016: Pythia8+EvtGen130 generation of Lb --> MuMu P K-, 13TeV, Tune CUETP8M1')
        )
...
ProductionFilterSequence = cms.Sequence(generator*bfilter*lbfilter)
