...
#                user_decay_file =  cms.vstring('GeneratorInterface/EvtGenInterface/data/LambdaB_mumupK.dec'),
		user_decay_embedded = cms.vstring('#',
'# This is the decay file for the decay LambdaB to Psi(2s) p K',
'#',
'#',
...
configurationMetadata = cms.untracked.PSet(
        ...
        annotation = cms.untracked.string('Spring 2016: Pythia8+EvtGen130 generation of Lb --> Psi(2s) P K-, 13TeV, Tune CUETP8M1')
        )
...
lbfilter = cms.EDFilter(
        ...
        DaughterIDs = cms.untracked.vint32(100443, 2212, -321), # psi(2s) p+ K- 
        ParticleID      = cms.untracked.int32(5122),
...
ProductionFilterSequence = cms.Sequence(generator*bfilter*lbfilter*Psi2sfilter)
